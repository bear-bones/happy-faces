function get_report(report) {
    ...
    case 'meals>blank>breakfast': return {
        ...
        generate : function () {meals.excel.meals.meal.generate(1, 'breakfast')}};
    ...
    case 'meals>blank>afternoon': return {
        ...
        generate : function () {meals.excel.meals.meal.generate(1, 'afternoon')}};
    ...
    case 'meals>complete>breakfast': return {
        ...
        generate : function () {meals.excel.meals.meal.generate(0, 'breakfast')}};
    ...
    case 'meals>complete>afternoon': return {
        ...
        generate : function () {meals.excel.meals.meal.generate(0, 'afternoon')}};
