function init() {
    var create = 'CREATE TABLE IF NOT EXISTS config (config_key INTEGER PRIMARY KEY, default_class TEXT, cash_in_lue DECIMAL, report_dir TEXT, cat1_desc TEXT, cat1_min_age INTEGER, cat1_max_age INTEGER, cat1_teacher TEXT, cat2_desc TEXT, cat2_min_age INTEGER, cat2_max_age INTEGER, cat2_teacher TEXT, cat3_desc TEXT, cat3_min_age INTEGER, cat3_max_age INTEGER, cat3_teacher TEXT, cat4_desc TEXT, cat4_min_age INTEGER, cat4_max_age INTEGER, cat4_teacher TEXT, cat5_desc TEXT, cat5_min_age INTEGER, cat5_max_age INTEGER, cat5_teacher TEXT, cat6_desc TEXT, cat6_min_age INTEGER, cat6_max_age INTEGER, cat6_teacher TEXT, cat7_desc TEXT, cat7_min_age INTEGER, cat7_max_age INTEGER, cat7_teacher TEXT, cat8_desc TEXT, cat8_min_age INTEGER, cat8_max_age INTEGER, cat8_teacher TEXT, br_start INTEGER, br_end INTEGER, br_a_rate DECIMAL, br_b_rate DECIMAL, br_c_rate DECIMAL, ms_start INTEGER, ms_end INTEGER, ms_a_rate DECIMAL, ms_b_rate DECIMAL, ms_c_rate DECIMAL, lu_start INTEGER, lu_end INTEGER, lu_a_rate DECIMAL, lu_b_rate DECIMAL, lu_c_rate DECIMAL, as_start INTEGER, as_end INTEGER, as_a_rate DECIMAL, as_b_rate DECIMAL, as_c_rate DECIMAL, di_start INTEGER, di_end INTEGER, di_a_rate DECIMAL, di_b_rate DECIMAL, di_c_rate DECIMAL, es_start INTEGER, es_end INTEGER, es_a_rate DECIMAL, es_b_rate DECIMAL, es_c_rate DECIMAL)',
        insert = "INSERT OR IGNORE INTO config VALUES (1, 'A', 0, '', 'Beginners', 0, 8, 'TERESA SANCHEZ', 'Movers', 9, 17, 'MARTHA MENDEZ', 'Climbers', 18, 24, 'NOHEMI HERNANDEZ', 'Curiosity', 25, 35, 'DIANA GONZALEZ', 'Discovery', 36, 47, 'GLORIA CALDERON', 'Creativity', 48, 59, 'ROSA OLVERA', 'Kinder', 60, 83, 'JOHANA LUGO', 'Enrichment', 84, 216, 'MARIA GARCIA', 450, 540, 1.58, 1.28, 0.28, 660, 660, 0, 0, 0, 660, 780, 2.93, 2.53, 0.28, 870, 990, 0.8, 0.4, 0.07, 1020, 1110, 2.93, 2.53, 0.28, 1170, 1230, 0.80, 0.40, 0.07)";
