function open() {
    ...
    input.setAttribute('value', meals.config.fee_amount);
    ...
    input.setAttribute('value', meals.config.prepared_by);
    ...
    for (var i = 0, mins = new Array(4), maxes = new Array(4); i < 4; ++i) {
        ...
        input.setAttribute('type', 'number');
        input.setAttribute('value', meals.config[rate + '_min_age']);
        ...
        input.setAttribute('type', 'number');
        input.setAttribute('value', meals.config[rate + '_max_age']);
        ...
        input.setAttribute('type', 'number');
        input.setAttribute('step', 'any');
        input.setAttribute('value', meals.config[rate + '_hourly_rate']);
        ...
        input.setAttribute('type', 'number');
        input.setAttribute('step', 'any');
        input.setAttribute('value', meals.config[rate + '_daily_rate']);
